...
class Game():
    ...
    def check_guess(self, guess):
        ...
        if distance == 0 : # if user's guess is correct
            print(f"Congratulations! You guessed the correct number in {ATTEMPTS_NUM-self.attempts} tries.")
            exit() 
        elif distance > 0 :
            print(f"The number is somewhere lower! {self.attempts} attempts left")

        elif distance < 0 : 
            print(f"The number is somewhere higher! {self.attempts} attempts left")
